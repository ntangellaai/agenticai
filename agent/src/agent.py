...
- Contracts by AM: query("SELECT contract_number,customer_name,service_name,contract_total_monthly FROM v_contract_summary WHERE account_manager ILIKE '%Smith%'",database="service_express_uk")
