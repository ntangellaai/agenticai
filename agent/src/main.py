...
<body>
    <div class="header">
        ...
        <a href="/oauth2/sign_out?rd=https://keycloak.serviceexpress.com/realms/demo/protocol/openid-connect/logout?post_logout_redirect_uri=https://agenticai.serviceexpress.com/" class="logout-btn">Logout</a>
    </div>
    <div class="container">
